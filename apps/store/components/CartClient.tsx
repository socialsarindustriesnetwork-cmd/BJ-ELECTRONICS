  ...
  return (
    <div className="cart-layout">
      <section className="cart-panel">
        <div className="panel-title"><div><p className="eyebrow">Shopping cart</p><h1>{cart.itemCount} item{cart.itemCount === 1 ? "" : "s"}</h1></div><Link href="/#catalog">Continue shopping</Link></div>
