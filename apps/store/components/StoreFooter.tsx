  ...
  return (
    <footer className="caravan-footer">
      ...
      <section className="caravan-footer-main">
        ...
        <div><h3>Company information</h3><Link href="/about">About us</Link><a href="mailto:support@bjelectronics.shop?subject=Careers">Join our team</a><Link href="/privacy">Privacy policy</Link><Link href="/terms">Terms & conditions</Link><Link href="/contact">Contact us</Link></div>
