  ...
  return (
    <footer className="caravan-footer">
      ...
      <section className="caravan-footer-main">
        ...
        <div><h3>Company information</h3><a href="mailto:support@bjelectronics.shop?subject=About%20BJ%20Electronics">About us</a><a href="mailto:support@bjelectronics.shop?subject=Careers">Join our team</a><a href="mailto:support@bjelectronics.shop?subject=Privacy%20policy">Privacy policy</a><a href="mailto:support@bjelectronics.shop">Contact us</a></div>
        <div><h3>Shopping information</h3><a href="mailto:support@bjelectronics.shop?subject=Shipping%20and%20delivery">Shipping & delivery</a><a href="mailto:support@bjelectronics.shop?subject=Return%20policy">Return policy</a><a href="mailto:support@bjelectronics.shop?subject=Refund%20policy">Refund policy</a><a href="mailto:support@bjelectronics.shop?subject=Terms%20and%20conditions">Terms & conditions</a></div>
