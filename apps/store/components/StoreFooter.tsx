    ...
    <footer className="commerce-footer caravan-footer full-market-footer">
      ...
      <div className="footer-main caravan-footer-main">
        <div className="footer-brand">
          ...
          <div className="footer-contact-list"><a href="mailto:support@bjelectronics.shop">support@bjelectronics.shop</a><span>Bangladesh</span><span>Customer care available Sat–Thu</span></div>
        </div>
        ...
        <div><h3>Customer care</h3><Link href="/contact">Contact us</Link><Link href="/shipping-returns">Shipping & returns</Link><Link href="/cart">Shopping cart</Link><Link href="/checkout">Secure checkout</Link><Link href="/privacy">Privacy policy</Link><Link href="/terms">Terms & conditions</Link></div>
        <div><h3>Payment & security</h3><div className="payment-chips"><span>COD</span><span>Bank</span><span>Secure</span></div><p>Supported checkout methods are cash on delivery and bank transfer. Inventory, pricing and order totals are validated before fulfilment.</p><div className="footer-security-note">✓ Secure cart · ✓ Protected order processing</div></div>
      </div>
