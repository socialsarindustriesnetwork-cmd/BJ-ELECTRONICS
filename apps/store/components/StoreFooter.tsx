  ...
  return (
    <footer className="commerce-footer caravan-footer full-market-footer">
      ...
      <div className="footer-main caravan-footer-main">
        ...
        <div><h3>Customer care</h3><Link href="/track-order">Track an order</Link><Link href="/contact">Contact us</Link><Link href="/faq">FAQ</Link><Link href="/shipping-returns">Shipping & returns</Link><Link href="/warranty">Warranty information</Link><Link href="/privacy">Privacy policy</Link><Link href="/terms">Terms & conditions</Link></div>
