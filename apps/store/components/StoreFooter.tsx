  ...
  return (
    <footer className="commerce-footer caravan-footer">
      ...
      <div className="footer-main caravan-footer-main">
        ...
        <div><h3>Shop</h3><Link href="/shop?category=Laptops">Laptops</Link><Link href="/shop?category=Headphones">Audio</Link><Link href="/shop?category=Smart%20Watches">Wearables</Link><Link href="/shop?category=Accessories">Accessories</Link><Link href="/shop?sort=discount">Special offers</Link></div>
        <div><h3>Customer care</h3><Link href="/contact">Contact us</Link><Link href="/track-order">Track order</Link><Link href="/cart">Shopping cart</Link><Link href="/policies/shipping">Shipping & delivery</Link><Link href="/policies/returns">Return policy</Link><Link href="/policies/refunds">Refund policy</Link></div>
        ...
        <div><h3>Payment & security</h3><div className="payment-chips"><span>Cash on delivery</span><span>Bank transfer</span></div><p>Inventory, pricing and order totals are validated before fulfilment.</p><div className="footer-security-note">✓ Secure cart · ✓ Protected order processing</div></div>
      </div>
