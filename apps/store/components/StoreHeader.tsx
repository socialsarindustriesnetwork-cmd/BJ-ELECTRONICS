    ...
    <>
      <div className="market-announcement">
        <div className="market-announcement-inner">
          ...
          <div><a href="tel:+8800000000000">Hotline: +880 0000-000000</a><Link href="/categories">Track offers</Link><a href="mailto:support@bjelectronics.shop">Customer care</a></div>
        </div>
      </div>
