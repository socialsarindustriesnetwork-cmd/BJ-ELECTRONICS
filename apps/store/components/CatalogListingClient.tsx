...
export function CatalogListingClient({ products, adminUrl }: { products: Product[]; adminUrl: string }) {
  ...
  return (
    <div className="store-shell listing-shell full-market-listing-shell">
      ...
      <main className="listing-main">
        ...
        <section className="full-listing-banner"><div><span>BJ Electronics marketplace</span><h1>Find the right electronics and appliances.</h1><p>Filter the live catalog by department, brand, price and availability.</p></div><Link href="/categories?sort=discount">Browse current deals</Link></section>
