      ...
      <main className="marketplace-listing-main">
        ...
        <div className="listing-layout market-listing-layout">
          <aside className={`catalog-filters market-filters${filtersOpen ? " open" : ""}`}>
            ...
            <div className="filter-support-card"><span>Need buying advice?</span><strong>Talk to our electronics team.</strong><a href="mailto:support@bjelectronics.shop">Contact support →</a></div>
          </aside>
