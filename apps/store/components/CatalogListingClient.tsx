  ...
  return (
    <div className="store-shell listing-shell marketplace-listing-shell">
      ...
      <main className="listing-main">
        ...
        <div className="marketplace-listing-banner"><div><span>BJ Electronics marketplace</span><h1>Find the right electronics and appliances.</h1><p>Filter the live catalog by department, brand, price and availability.</p></div><Link href="/categories?sort=discount">Browse current deals</Link></div>
