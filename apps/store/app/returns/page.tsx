  ...
  return (
    <div className="store-shell">
      ...
      <main className="content-page">
        ...
        <section className="content-grid">
          <article className="content-card"><h3>Review process</h3><p>Requests are assessed against the product condition, delivery record, warranty terms and applicable store policy. Approved repair, replacement, return or refund instructions are communicated first.</p></article>
