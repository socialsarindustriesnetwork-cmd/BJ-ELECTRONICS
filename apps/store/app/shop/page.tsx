...
export default async function ShopPage() { const products = await listPublishedProducts({ limit: 250 }); return <CatalogListingClient products={products} adminUrl={getAdminUrl()} />; }
