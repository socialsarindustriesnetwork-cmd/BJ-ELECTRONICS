...
export const metadata: Metadata = { title: "Shop electronics", description: "Browse BJ Electronics laptops, audio, wearables, monitors, power products and accessories.", alternates: { canonical: "/shop" } };
