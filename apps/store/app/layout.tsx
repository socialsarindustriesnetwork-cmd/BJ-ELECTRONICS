...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: "BJ Electronics | Electronics & Appliances Marketplace",
    description: "Trusted electronics and appliances with live inventory, secure checkout and responsive support.",
    images: [{ url: "/brand/social/og-store.svg", width: 1200, height: 630, alt: "BJ Electronics online marketplace" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "BJ Electronics | Electronics & Appliances Marketplace",
    description: "Trusted electronics and appliances with live inventory and secure checkout.",
...
export const viewport: Viewport = {
  ...
  themeColor: [
    ...
    { media: "(prefers-color-scheme: dark)", color: "#0d47b5" },
  ],
};
