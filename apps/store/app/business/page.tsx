...
const services = [
  ["Product consultation", "Discuss requirements, compatibility, budgets and suitable product options."],
  ...
  return (
    <div className="store-shell">
      ...
      <main className="content-page">
        <section className="content-hero"><p className="eyebrow">BJ Electronics for business</p><h1>Dependable technology for teams and organizations.</h1><p>Get coordinated support for product selection, quotations, inventory planning, fulfilment and after-sales requirements.</p></section>
        ...
        <section className="content-grid">
          ...
          <article className="content-card"><h3>What to include</h3><p>Send the organization name, contact person, product categories, specifications, quantities, preferred delivery location and target timeline.</p></article>
